...
//
// Audio Direction (กติกาการใช้เสียง — ตรวจสอบแล้วว่าของเดิมใช้ตรงกันทั้งหมด):
//   บวก/ยืนยัน      → chime, heal      (กระดิ่ง/ขลุ่ยเบาๆ สั้น สดใส)
//   ลึกลับ/สืบสวน    → mystery         (โทนต่ำยาว + overtone)
//   ร้าย/อันตราย     → slash, death, drum (กระแทกสั้น คมชัด)
//   เปลี่ยนผ่านฉาก   → gong, whoosh    (สัญญาณเปิด/ปิดจังหวะ)
//   ทรัพย์สิน        → coins           (ระยิบเบาๆ ไม่แหลม)
//   ผลลัพธ์ใหญ่      → fanfare, lose, crazy (ท้ายเกม/จุดพลิกผัน เท่านั้น)
//   ปฏิสัมพันธ์เล็ก   → tick            (คลิก/เลือก สั้นที่สุด)
//   บรรยากาศ        → ambientCue      (สุ่มเบาๆ ไม่ใช่สัญญาณเกม)
// เพิ่มเสียงใหม่ ให้เลือกจากหมวดข้างบนก่อน อย่าคิดเสียงใหม่นอกหมวดโดยไม่จำเป็น
// ============================================================
